...
CREATE TABLE MONTH_TRANSACTION_TBL (
  ...
  CONSTRAINT MONTH_TRANSACTION_MONTH_FK FOREIGN KEY (MONTH_ID) REFERENCES MONTH_TBL ON DELETE CASCADE,
  CONSTRAINT MONTH_TRANSACTION_CATEGORY_FK FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY_TBL ON DELETE CASCADE,
  );
