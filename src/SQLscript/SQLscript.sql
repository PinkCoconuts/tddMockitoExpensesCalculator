...
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 1, 'accommodation', 7000, 'expense',2); 
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 1, 'gas for car', 2000, 'expense', 2); 
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 1, 'apples', 1200, 'expense', 4); 
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 1, 'salaryJan', 21738, 'income', 1); 
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 2, 'salaryFeb', 28214, 'income', 1);
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 3, 'salaryMar', 25108, 'income',1);
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 4, 'salary', 20136, 'income', 1);
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 5, 'salary', 27444, 'income', 1);
INSERT INTO MONTH_TRANSACTION_TBL VALUES(CPHCD77.MONTH_TRANSACTION_ID_SEQ.NEXTVAL, 6, 'salary', 22890, 'income', 1);
